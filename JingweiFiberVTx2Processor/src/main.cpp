...
int main()
{
	...
	auto run_softdog_check = [&](int pid, int vid)
	{
		chk_serial_number(pid, vid, 0);
		//return;
	};
	//std::thread soft_check([&] {run_softdog_check(0x0529, 0x0003); });
	//soft_check.detach();
	...
	//auto run_softdog_check = [&]()
	//{
	//	MonitorNetlinkUevent();
	//	return;
	//};
	//std::thread soft_check([&] {run_softdog_check(); });
	//soft_check.detach();
	//auto run_softdog_check = [&](int pid, int vid)
	//{
	//	printf("%d", chk_serial_number(pid, vid, 0));
	//	//return;
	//};
	//std::thread soft_check([&] {run_softdog_check(0x0529, 0x0003); });
	//soft_check.detach();
