...
public:
	...
	bool	receive_img(std::string& _error_str, boost::scoped_ptr<ip::tcp::socket> &socket_);
	...
	int		show_ctrl_message(boost::scoped_ptr<ip::tcp::socket>& socket_, int  wParam, void* lParam);
	int		show_ctrl_message(asio::basic_stream_socket<asio::ip::tcp>* socket, int  wParam, void* lParam, int length, uchar* m_buf);
	int		show_ctrl_message(boost::scoped_ptr<ip::tcp::socket>& socket_, int  wParam, void* lParam, int length, uchar* m_buf);
...
public:
	...
	//boost::shared_ptr<ip::tcp::socket> m_nsocket;

	//boost::scoped_ptr<ip::tcp::socket> m_nsocket;

	boost::scoped_ptr<ip::tcp::socket> socket_;
	tcp::endpoint  * ep_;

	asio::io_service m_io;
	asio::io_service m_io_image;
	...
	static boost::scoped_ptr<ip::tcp::socket> magnetic_valve_socket_;
	static boost::scoped_ptr<ip::tcp::socket> show_image_socket_;
