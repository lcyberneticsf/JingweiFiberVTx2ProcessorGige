...
//
//int CIni::WritePrivateProfileString_(char* section, char* key, char* valStr, char* fName)
//{
//	int ret;
//	ret = CFG_set_key(fName, section, key, valStr);
//	return(ret);
//}
